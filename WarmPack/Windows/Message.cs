...
namespace WarmPack.Windows
{
    ...
    //        var view = new WPF.Controls.Views.MessageBoxView();
    //        view.DataContext = vm;
    ...
    //        var view = new WPF.Controls.Views.MessageBoxInputView();
    //        view.DataContext = vm;
    ...
    //        var view = new WPF.Controls.Views.MessageBoxOptionsView();
    //        view.DataContext = vm;
